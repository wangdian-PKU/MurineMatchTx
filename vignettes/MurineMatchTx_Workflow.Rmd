...
The **MurineMatchTx** R package provides a cross-species transcriptomic similarity analysis workflow for mouse and human cancer models. Example input files are distributed separately as the archive `example_data.rar` and can be downloaded from the GitHub Release page for this repository.

# Example Data

Download `example_data.rar` from `https://github.com/wangdian-PKU/MurineMatchTx/releases/download/example-data/example_data.rar`, extract it locally, and use the resulting files as inputs to the functions shown below.
